...
const AboutSection: FC = memo(() => {
  ...
  return (
    <Section className="relative bg-neutral-900" noPadding sectionId={SectionId.About}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-14">
          ...
          <motion.div
            ...
            <motion.div variants={itemVariants}>
              ...
              <p className="normal-text text-base">{description}</p>
            </motion.div>
                ...
                <Card className="h-full backdrop-blur-sm bg-neutral-800 border border-gray-400">
                  <CardContent className="pt-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-sm normal-text">TAMU-SA (Texas A&M University - San Antonio)</p>
                      <p className="text-sm normal-text">2022 - Present</p>
                      <p className="text-sm normal-text">
                        Honors Society | Men's Volleyball Team Captain and Vicepresident | Chess Team Member | Research
                        Assistant
                      </p>
                    </div>
                  </CardContent>
                ...
                <Card className="h-full backdrop-blur-sm bg-neutral-800 border border-gray-400">
                  <CardContent className="pt-6">
                    ...
                    <div className="space-y-4">
                      <div>
                        <p className="font-medium text-white">Data Analyst Intern</p>
                        <p className="text-sm normal-text">Forte Innovation Consulting</p>
                        <p className="text-sm normal-text">April 2022 - November 2022</p>
                      </div>
                      <div>
                        <p className="font-medium text-gray-300">Backend Developer Intern</p>
                        <p className="text-sm normal-text">Forte Innovation Consulting</p>
                        <p className="text-sm normal-text">January 2023 - July 2024</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
          ...
          <motion.div
            ...
            viewport={{once: true, amount: 0.2}}
            whileInView="visible">
            <motion.div className="relative" variants={itemVariants} whileHover={{scale: 1.05}}>
              <Avatar className="w-40 h-40 border-4 border-primary/20">
                <AvatarImage alt="Eduardo Lara" loading="lazy" src="/imgs/me.jpg" />
            ...
            <motion.div className="flex flex-wrap gap-2 justify-center lg:justify-start" variants={itemVariants}>
              <Badge className="text-white bg-stone-800" variant="outline">
                Python
              </Badge>
              <Badge className="text-white bg-stone-800" variant="outline">
                Pandas
            ...
            <motion.div variants={itemVariants} whileHover={{scale: 1.03}} whileTap={{scale: 0.98}}>
              <Button asChild className="bg-orange-500 text-gray-900 rounded-full text-sm" onClick={handledownload}>
                <a download="Eduardo_Lara_CV.pdf" href={resumeUrl}>
