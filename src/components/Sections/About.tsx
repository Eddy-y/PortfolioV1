  ...
  return (
    <Section className="bg-neutral-800" sectionId={SectionId.About}>
      <div className={classNames('grid grid-cols-1 gap-y-4', {'md:grid-cols-3': !!profileImageSrc})}>
        ...
        <div className={classNames('col-span-1 flex flex-col gap-y-6', {'md:col-span-2': !!profileImageSrc})}>
          <div className="flex flex-col gap-y-2">
            <h2 className="text-2xl font-bold text-white">About me</h2>
            <p className="w-full text-sm text-gray-300 sm:prose-base">{description}</p>
          </div>
