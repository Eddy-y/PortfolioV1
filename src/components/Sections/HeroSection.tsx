...
const HeroSection = () => {
  return (
    ...
    >
      <div className="absolute inset-0 -z-10 bg-neutral-800"></div>
      ...
      {/* The main content container, now with the cards' order swapped */}
      <div className="section-container flex flex-col lg:flex-row items-center justify-between gap-10">

        {/* This is the code card, which is now on the left */}
        <motion.div
          className="w-full max-w-md"
          initial={{ opacity: 0, x: -50 }} // Adjusted the animation to come from the left
            ...
            >
              ...
              <div className="space-y-2 font-mono text-sm">
                ...
                >
                  ...
                  <span className="text-gray-500">:</span>{" "}
                  <span className="text-green-600">'Eduardo Lara'</span>
                  <span className="text-gray-500">,</span>
                </motion.div>
                ...
                >
                  ...
                  <span className="text-gray-500">:</span>{" "}
                  <span className="text-orange-500">[</span>
                  <span className="text-green-600">'Data Analysis'</span>
                  <span className="text-gray-500">,</span>{" "}
                  <span className="text-green-600">'Data Management'</span>
                  <span className="text-orange-500">]</span>
                  <span className="text-gray-500">,</span>
                </motion.div>
        ...
        {/* This is the text content block, now on the right */}
